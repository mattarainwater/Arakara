...
namespace Nez.Sprites
{
	...
	public class Sprite : RenderableComponent
	{
		...
		public Sprite( Subtexture subtexture )
		{
            ...
            _origin = Vector2.Zero;// subtexture.center;
            scale = Vector2.Zero;
		}
		...
		public override void render( Graphics graphics, Camera camera )
		{
			...
			graphics.batcher.draw( _subtexture, entity.transform.position + localOffset, color, entity.transform.rotation, origin, renderScale, spriteEffects, _layerDepth );
		}
